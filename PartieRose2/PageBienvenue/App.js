  ...
  <body class="bg-body">
    ...
    <div class="row justify-content-center">
      <div class="col-xl-4 col-md-5 col-sm-8 col-10 text-center">
        ...
        height="auto"
        width="192px" />
        <h1 class="h1 color-primary"> Bienvenue </h1>
        <form method="post" action="">
            ...
            <div class="text-start mb-4">
              <a class="btn btn-link text-start color-primary" href="#">Mot de passe oublié ?</a>
            </div>
            <div class="button">
        ...
        <div class="my-2"> ou </div>
          <div class="button">
            <a class="btn btn-primary" href="#">S'incrire</a>
          </div>
      </form>
    </div>
  </div>
